                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="mt-7 space-x-3">
                            <button
                                type="submit"
                                disabled={processing}
                                className="inline-flex items-center rounded-md bg-indigo-600 px-4 py-[11px] text-sm font-medium text-white shadow-sm transition-colors hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 disabled:cursor-not-allowed disabled:opacity-50"
                            >
                                ...
                                >
                                    ...
                                    {Object.entries(modules).map(
                                        ([module, perms]) => (
                                            <div
                                                key={module}
                                                className="border-gray-600 bg-white dark:bg-black"
                                            >
                                                {/* Module Checkbox */}
                                                <div className="flex items-center gap-3 border-b border-gray-100 bg-gray-50 px-4 py-3 transition-colors dark:border-gray-800 dark:bg-gray-900/80">
                                                    <input
                                                        type="checkbox"
                                                        checked={perms.every(
                                                            (
                                                    ...
                                                    {perms.map((permission) => (
                                                        ...
                                                        >
                                                            ...
                                                            <label
                                                                ...
                                                                className="ml-3 rounded bg-blue-100/50 px-3 py-1 text-sm font-medium text-gray-700 transition-colors hover:bg-blue-200/50 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700"
                                                            >
                                                                {permission}
                                                            </label>
                                                        </div>
